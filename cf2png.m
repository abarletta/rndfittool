%% CF2PDF - Exports current figure into png file
% This function exports the current figure into a png file by matching a
% user defined ratio.
% 
% Usage:
%
%  CF2PNG(ratio,tgtFile)       
%
% Input:
%
...
%  CF2PNG('ISO216l','test.png');

function status=CF2PNG(varargin)
