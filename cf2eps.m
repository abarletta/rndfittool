%% CF2PDF - Exports current figure into EPS file
...
% Input:
%
%       ratio  -  indicates the ratio to be used in the exported eps file
...
%  CF2PDF('ISO216l','test.eps');

function status=cf2eps(varargin)
